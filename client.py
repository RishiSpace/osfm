...
def main():
    ...
    install_command_processed = False  # Flag to prevent multiple installations
            ...
            try:
                ...
                if command.startswith("FILE_PATH"):
                    ...
                    if file_path:  # Ensure file_path is set
                        if not install_command_processed:  # Check if installation was already done
                            print(f"Attempting to install software: {file_path}")
                            install_software(file_path)
                            install_command_processed = True  # Set the flag to True after installation
                        else:
                            print("Install command already processed. Ignoring duplicate.")
                    else:
